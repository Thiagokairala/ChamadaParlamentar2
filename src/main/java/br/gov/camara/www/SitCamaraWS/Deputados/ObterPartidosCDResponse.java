...
public class ObterPartidosCDResponse  implements java.io.Serializable {
     ...
     */
    public void setObterPartidosCDResult(br.gov.camara.www.SitCamaraWS.Deputados.ObterPartidosCDResponseObterPartidosCDResult obterPartidosCDResult) {
        this.obterPartidosCDResult = obterPartidosCDResult;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ObterPartidosCDResponse)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.obterPartidosCDResult==null && other.getObterPartidosCDResult()==null) || 
             (this.obterPartidosCDResult!=null &&
              this.obterPartidosCDResult.equals(other.getObterPartidosCDResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ObterPartidosCDResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.camara.gov.br/SitCamaraWS/Deputados", ">ObterPartidosCDResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("obterPartidosCDResult");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.camara.gov.br/SitCamaraWS/Deputados", "ObterPartidosCDResult"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.camara.gov.br/SitCamaraWS/Deputados", ">>ObterPartidosCDResponse>ObterPartidosCDResult"));
